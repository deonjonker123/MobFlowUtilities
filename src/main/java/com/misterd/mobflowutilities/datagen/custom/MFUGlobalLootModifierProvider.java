    ...
    protected void start() {
        ...
        for (String mob : allMobs) {
            addMobLoot("incubation_crystal_from_" + mob.replace("entities/", ""),
                    mob, MFUItems.LIFE_CATALYST, 0.0001F);
        }
        ...
        addBossLoot("incubation_crystal_from_ender_dragon", "entities/ender_dragon", MFUItems.LIFE_CATALYST);
        addBossLoot("incubation_crystal_from_elder_guardian", "entities/elder_guardian", MFUItems.LIFE_CATALYST);
        addBossLoot("incubation_crystal_from_warden", "entities/warden", MFUItems.LIFE_CATALYST);
        addBossLoot("incubation_crystal_from_wither", "entities/wither", MFUItems.LIFE_CATALYST);
        addBossLoot("incubation_crystal_from_ravager", "entities/ravager", MFUItems.LIFE_CATALYST);
