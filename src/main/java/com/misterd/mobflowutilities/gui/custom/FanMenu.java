...
public class FanMenu extends AbstractContainerMenu {
    ...
    public FanMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
        ...
        addSlot(new ModuleSlot(this.blockEntity.inventory, 0, 44, 18, MFUItems.FAN_WIDTH_INCREASE_MODULE.get()));
        addSlot(new ModuleSlot(this.blockEntity.inventory, 1, 80, 18, MFUItems.FAN_HEIGHT_INCREASE_MODULE.get()));
        addSlot(new ModuleSlot(this.blockEntity.inventory, 2, 116, 18, MFUItems.FAN_DISTANCE_INCREASE_MODULE.get()));
    }

    @Override
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, MFUBlocks.FAN.get());
    }
